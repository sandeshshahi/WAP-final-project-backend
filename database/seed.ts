...
export const seed = () => {
  ...
  const policies = [
    ...
    },
    {
      ...
      description:
        "This policy outlines the procedure for renewing student visas for international students. It details the required documents, submission timelines, and the processing duration. Additionally, it includes information about maintaining visa compliance, avoiding delays in application submission, and tips for meeting embassy requirements. Students are advised to seek assistance from the university's visa office for guidance during the process.",
    ...
    },
    {
      ...
      description:
        "This policy establishes guidelines for the effective and fair usage of the campus meditation room. It provides a schedule for individual and group meditation sessions and sets rules for maintaining silence and cleanliness. Additionally, it outlines procedures for reserving the space and reporting any disturbances. Students are encouraged to use the meditation room to foster well-being and stress relief.",
    ...
    },
    {
      ...
      description:
        "This policy provides essential travel guidelines for students participating in exchange programs. It includes information on insurance, documentation, and the importance of adhering to the host country's laws. The policy highlights pre-departure training and tips for maintaining safety during travel. Students are also advised to stay connected with the university's program coordinators for assistance.",
    ...
    },
    {
      ...
      description:
        "This policy outlines the rules for reserving and utilizing general campus facilities such as conference halls, sports arenas, and study rooms. It includes booking procedures, usage time limits, and responsibilities of the users. Students and faculty are encouraged to follow these guidelines to ensure fair access and avoid scheduling conflicts. The policy also specifies steps to report facility damages or issues promptly.",
    ...
    },
    {
      ...
      description:
        "This policy highlights the revised eligibility criteria for university scholarships aimed at supporting academic excellence. It includes new GPA thresholds, community involvement requirements, and application deadlines. The policy encourages students to consult with the financial aid office for personalized assistance in meeting these criteria. Notifications regarding upcoming scholarship opportunities will be sent regularly.",
    ...
    },
    {
      ...
      description:
        "This policy provides guidelines for students wishing to participate in meditation workshops organized on campus. It includes details about registration procedures, attendance limits, and session timings. Additionally, it emphasizes creating a distraction-free environment by requesting participants to arrive on time and keep their phones on silent. The workshops aim to foster mindfulness and emotional well-being.",
    ...
    },
    {
      ...
      description:
        "This policy outlines the late fee structure for overdue library materials and the process for applying for fine waivers. It includes exemptions for students facing financial hardships or emergencies. The policy encourages students to return borrowed items on time to avoid fines. Users can appeal for waivers through a formal process documented in this policy.",
  ...
  const policyStatement = db.prepare(
    "INSERT INTO policies (id, title, description, date, category, user_id) VALUES (?, ?, ?, ?, ?, ?)"
  );
  ...
  const voteStatement = db.prepare(
